	...
	<div class="shop-search-body-wrap">
		...
		<div class="catelog-filter-wrap container">
			<div class="catelog-filter">
				<c:forEach var="entry"
					items="${commodyBelongKeywordStatisticMap.entrySet() }">
		...
		<div class="search-filter-container container clearfix">
			<span class="search-keywords">${keyword }</span> <span
		...
		<div class="search-result-list-wrap container">
			<ul class="search-result-list">
				<c:forEach var="searchCommody" items="${searchCommodyBelongKeyword }">
					<li class="result-list-item clearfix">
						...
						<div class="user-info">
							<img src="<c:url value="/resource/upload/img/${searchCommody.user.avatar }" />" />
							<div class="pull-left">
