      ...
      <div class="panel panel-default usercenter-panel">
        <div class="panel-heading usercenter-panel-heading">
            ...
            <ul class="nav nav-tabs">
              ...
              <li><a href="#user-profile" data-toggle="tab">个人资料</a></li>
              <li class=" active"><a href="#edit-user-profile" data-toggle="tab">编辑资料</a></li>
            </ul>
        </div>
        <div class="panel-body">
          <div class="tab-content">
            ...
            <div class="tab-panel" id="user-profile">
            ...
            <div class="tab-panel active" id="edit-user-profile">
              <div class="well">
