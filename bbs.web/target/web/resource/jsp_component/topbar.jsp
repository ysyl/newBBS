      ...
      <div class="container-fluid bbs-navbar-container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#">交易区</a></li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">通知<span class="caret"></span></a>
                <ul class="dropdown-menu notice-menu" id="notice-menu">
                  ...
                  <div class="tab-content" id="notice-menu-content">
                    <div class="tab-panel active" id="trend"></div>
          ...
          <form class="navbar-form navbar-right" action="<c:url value="/search" />" method="get">
            <div class="form-group search-form">
              <div class="input-group">
                <input type="text" name="title" class="form-control search-form-input" placeholder="Search">
                <div class="input-group-btn">
                  <button type="button" class="btn btn-default dropdown-toggle" id="search-selector" data-toggle="dropdown">
                    本版
